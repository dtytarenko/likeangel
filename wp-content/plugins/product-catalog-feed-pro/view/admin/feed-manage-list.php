...
class WpWoof_Feed_Manage_list extends Wpwoof_Feed_List_Table {
    ...
    function column_default($item, $column_name) {
        ...
        $upload_dir = wpwoof_feed_dir($itemInfo['feed_name'],'xml');
        $upload_dir_csv = wpwoof_feed_dir($itemInfo['feed_name'],'csv');
        ...
        switch ($column_name) {
	        ...
	        case 'feednumber':
		        ...
		        return '<div class="wpwoof-feednumber-content">
							<div class="wpwoof-feednumber">' . $this->item_index . '</div>
            ...
            case 'feedname':
                ...
                return  '<div class="wpwoof-feedname-content"><div class="wpwoof-loader" '.$loaders_style.'></div>&nbsp;' .  $addStr.$itemInfo['feed_name'] . '</div>';
            case 'feed_type':
                switch($itemInfo['feed_type']){
                    ...
                    case "googleReviews": return "Reviews for Google Merchant";
            ...
            case 'feedupdate':
                ...
                $return .= "<a disabled='disabled' id='wpwoof_status_".$option_id."a' class='wpwoof-button-forlist gray regenerate' href='$update'>" . __('Regenerate') . "</a>"."<div class='wpwoof_statusbar' id='wpwoof_status_".$option_id."' data-feedid='".$option_id."' ".$loaders_style."><img id='wpwoof_img_".$option_id."' style='margin-left: ".$img_margin_left."px;' src='".WPWOOF_URL."/assets/img/bar.png' /></div>";
                $return .= "<a disabled='disabled' class='wpwoof-button-forlist gray' href='".$delete."'>" . __('Delete') . '</a>';
               return $return;

            case 'feeddownload':
                $return = ($itemInfo['feed_type']=="adsensecustom" ) ? '' : '<a disabled="disabled" id="wpwoof_status_'.$option_id.'x" class="wpwoof-button-forlist wpwoof-hide-feed-button gray" '.$hideFeedButtons.' href="'.$upload_dir['url'].'" download>XML</a>';
                if ($itemInfo['feed_type']!="googleReviews" )$return .= '<a disabled="disabled" id="wpwoof_status_'.$option_id.'c" class="wpwoof-button-forlist wpwoof-hide-feed-button gray" '.$hideFeedButtons.' href="'.$upload_dir_csv['url'].'" download>CSV</a>';
