...
if ( ! class_exists( 'YITH_Pre_Order_Product' ) ) {
	...
	class YITH_Pre_Order_Product {
		...
		public function set_pre_order_no_date_label( $pre_order_no_date_label ) {
			if ( isset( $pre_order_no_date_label ) ) {
				yit_save_prop( $this->product, '_ywpo_preorder_no_date_label', $pre_order_no_date_label );
		...
		public function get_pre_order_no_date_label() {
			$pre_order_no_date_label = yit_get_prop( $this->product, '_ywpo_preorder_no_date_label', true );
