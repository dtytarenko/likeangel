...
define('WCUS_OPTION_ONLY_CARGO_WAREHOUSES', 'wcus_only_cargo_warehouses');
define('WCUS_OPTION_SHOW_POSHTOMATS', 'wcus_show_poshtomats');
define('WCUS_OPTION_LOADER_LAST_SYNC', 'wcus_loader_last_sync');
define('WCUS_OPTION_NP_FREE_SHIPPING_TITLE_ACTIVE', 'wcus_np_free_shipping_title_active');
define('WCUS_OPTION_NP_FREE_SHIPPING_TITLE', 'wcus_np_free_shipping_title');
define('WCUS_OPTION_CLOUD_TOKEN', 'wcus_cloud_token');