...
public function set_site_license( $data = array() ) {
    ...
    update_option( 'monsterinsights_license', $dummy_data );
    $this->set_site_license_updates();
    $this->site = $dummy_data;
}
...
public function set_network_license( $data = array() ) {
    ...
    update_site_option( 'monsterinsights_network_license', $dummy_data );
    $this->set_network_license_updates();
    $this->network = $dummy_data;
}
