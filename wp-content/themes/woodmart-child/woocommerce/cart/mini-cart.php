...
if ( $has_unavailable_products ) {
    echo '<div class="mini-cart-availability-warning" style="color: red; margin: 15px 0;">' .
        esc_html__( 'На жаль, деяких продуктів немає в наявності, щоб завершити замовлення приберіть недоступні до замовлення товари з корзини', 'woocommerce' ) .
        '</div>';
}
?>
								...
								<div class="cart-info">
									...
									<?php
										if ( ! $_product->is_in_stock() ) {
											echo '<div class="wd-out-of-stock" style="color:red; margin-top:5px;">' . esc_html__( 'Немає у наявності', 'woocommerce' ) . '</div>';
